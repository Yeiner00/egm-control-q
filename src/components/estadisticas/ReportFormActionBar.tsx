...
const actionBarClass = "sticky bottom-0 z-20 -mx-4 -mb-4 flex flex-col gap-2 rounded-b-[calc(var(--radius)-0.08rem)] border-t border-border/70 bg-card px-4 py-3 shadow-[0_-18px_32px_-28px_rgba(15,23,42,0.45)] backdrop-blur supports-[backdrop-filter]:bg-card/60 sm:flex-row sm:items-center sm:justify-between dark:shadow-none";
